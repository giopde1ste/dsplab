...
WorkQueue::CWorkerThread::CWorkerThread(const char * const naam,
                                        uint16_t SD,
                                        UBaseType_t Prio,
                                        WorkQueue *Parent)
    : Thread(naam, SD, Prio), ParentWorkQueue(Parent)
{
}


WorkQueue::CWorkerThread::CWorkerThread(uint16_t SD,
                                        UBaseType_t Prio,
                                        WorkQueue *Parent)
    : Thread(SD, Prio), ParentWorkQueue(Parent)
{
}
