...
# $Id: STM32F303xc.cmake 4390 2022-02-24 14:44:20Z ewout $
#************************************************************************
 
message(STATUS "Bouw HAL target voor STM32F303x6 met 256 KByte Flash en 48K SRAM")

set(STM32DeviceType stm32f303xc)

add_definitions(-DARMCORTEXM4)
add_definitions(-Darm -Dstm32 -Dstm32f30x -DSTM32F30X -DSTM32F303xC)
...
set(stm32linkermap ${STM32StdPeriphHALGemeenschappelijkDir}/ldscripts/STM32F30x_256k_48k_flash.ld)
set(StartupCode Source/Templates/gcc/startup_${STM32DeviceType}.s)
